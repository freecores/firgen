...
/***************************************************************************
                          structure2vhdl87.h  -  description
                             -------------------
...
#ifndef STRUCTURE2VHDL87_H
#define STRUCTURE2VHDL87_H
...
class structure2vhdl87:protected fir2hdl{
public:

  structure2vhdl87(structureList * sl, implement *im,char * z_SrcFile, char * z_LogFile);
  ~structure2vhdl87();
